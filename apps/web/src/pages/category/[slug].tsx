...
type Props = {
  projects: Awaited<ReturnType<typeof fetchProjectsByCategory>>;
  slug: string;
};

export default function ProjectsOverviewPage({projects, slug}: Props) {
  return (
    <MainLayout>
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  ...
  const projects = await fetchProjectsByCategory(slug);
